...
import com.geekscanteen.Backend.dao.AdminDao;
...
import com.geekscanteen.Backend.exceptions.CategoryNameAlreadyExistsException;
import com.geekscanteen.Backend.exceptions.ItemNameAlreadyExistsException;
import com.geekscanteen.Backend.exceptions.NotAnAdminException;
import com.geekscanteen.Backend.exceptions.SubCategoryNameAlreadyExistsException;
...
public class AdminServiceImpl implements AdminService {
	...
	public Category addCategory(String userId, Category category) {
		...
		System.err.println(!categories.isEmpty());
//		System.err.println(categories.get(0));
	...
	public SubCategory addSubCategory(int category, SubCategory subCategory) {
		...
		System.err.println(!subCategories.isEmpty());
